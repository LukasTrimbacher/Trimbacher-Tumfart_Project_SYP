...
With the FinenceM application our team is working on the target to make it as easy as possible to creat an overview for the user about his in and outgoings.
